...
keys["bitbucket"] = ['pr_title', 
                     'pr_contents', 
                     'pr_comments']
fname["bitbucket"] = 'noenergy_data/bitbucket_pr_data.json'
...
keys["stackoverflow"] = ['title', 
                         ...
                         'question_code', 
                         'answer_code']
fname["stackoverflow"] = 'noenergy_data/new_stackoverflow_data.json'
# ROSDiscurse
...
fname["rosdiscurse"] = 'noenergy_data/ros-discourse_data.json'
...
fname["rosanswers"] = 'noenergy_data/ros-answers_data.json'

# Wiki
cols["wiki"] = [db.Wiki]
fname["wiki"] = 'noenergy_data/wiki_energy_data.json'
# PRS Git
...
fname["prsgit"] = 'noenergy_data/github-prs_data.json'
# Open Issues
...
fname["issues"] = 'noenergy_data/new_github-issues_data.json'
"""
# Commits
cols["commit"] = [db.Commits]
keys["commit"] = [ 'Commit Info'
                  ]
fname["commit"] = 'noenergy_data/commit_data_new.json'
"""
# Repo
...
fname["repo"] = 'noenergy_data/repositories_data.json'
"""
##############################
### EXECUTION
#####
